...
define(["signals"], function (signals)
{
    ...
    pageInfo.TIMELINE_LAYOUT = {
        ...
        p_content2012_open:{position:pageInfo.FOV_RELATED,
            parent:"h3_date2012",
            x:{minL:-15, maxL:-15},
            y:{minL:-3, maxL:-3 },
        ...
        p_content2006:{position:pageInfo.FOV_RELATED,
            ...
            scale:{minL:0.6, maxL:1},
            width:270, height:36, clickHandler:"openDatePanel"},
        p_content2006_open:{position:pageInfo.FOV_RELATED,
            parent:"h3_date2006",
            x:{minL:-15, maxL:-15},
            y:{minL:-3, maxL:-3 },
            z:0, useOffsetRatio:true,
        ...
        p_content2004:{position:pageInfo.FOV_RELATED,
         ...
         p_content2004_open:{position:pageInfo.FOV_RELATED,
            parent:"h3_date2004",
            x:{minL:-15, maxL:-15},
            y:{minL:-3, maxL:-3 },
            z:0, useOffsetRatio:true,
        ...
        p_content1999_open:{position:pageInfo.FOV_RELATED,
            parent:"h3_date1999",
            x:{minL:-15, maxL:-15},
            y:{minL:-3, maxL:-3 },
            z:0, useOffsetRatio:true,
       ...
       p_content1997_open:{position:pageInfo.FOV_RELATED,
            parent:"h3_date1997",
            x:{minL:-15, maxL:-15},
            y:{minL:-3, maxL:-3 },
            z:0, useOffsetRatio:true,
