...
define(["signals"], function (signals)
{
    ...
    pageInfo.TIMELINE_LAYOUT = {
        ...
        p_content2006:{position:pageInfo.FOV_RELATED,
            parent:"h3_date2006",
            x:{minL:40, maxL:90},
            y:{minL:5, maxL:11}, z:-3550, useOffsetRatio:true,
        ...
        p_content2004:{position:pageInfo.FOV_RELATED,
            parent:"h3_date2004",
            x:{minL:40, maxL:90},
            y:{minL:5, maxL:11}, z:-3350, useOffsetRatio:true,
        ...
        p_content2001:{position:pageInfo.FOV_RELATED,
            parent:"h3_date2001",
            x:{minL:40, maxL:90},
            y:{minL:5, maxL:11}, z:-3150, useOffsetRatio:true,
        ...
        p_content1999:{position:pageInfo.FOV_RELATED,
            parent:"h3_date1999",
            x:{minL:40, maxL:90},
            y:{minL:5, maxL:11}, z:-2950, useOffsetRatio:true,
        ...
        p_content1997:{position:pageInfo.FOV_RELATED,
            parent:"h3_date1997",
            x:{minL:40, maxL:90},
            y:{minL:5, maxL:11}, z:-2750, useOffsetRatio:true,
